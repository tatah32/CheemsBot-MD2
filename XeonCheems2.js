...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                XeonBotInc.sendMessage(m.chat, { image: { url: 'https://images.app.goo.gl/mpjZFyXzUzNBghzt9' }, caption: `*Hi Bro ${m.pushName}*\n\nDonate Me : \n\n🐶 Fampay : If You Want To Donate, Talk With The Owner First\nwa.me/62 89668014332 (Click To Contact)` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply(`GitHub : https://github.com/tatah32/CheemsBot-MD2.git\n Dont Forget To Give Star\n\nYouTube : ${myweb}\nDont Forget To Watch Tutorial`)
            }
            break
case 'allmenu': {
  	anu = `
